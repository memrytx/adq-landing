...
const rows=[
  ['3D', 'FBX, OBJ, C4D, BLEND', 'Reference videos of the assets; Pivot at (0,0,0); Correct model scale'],
  ['2D', 'PNG, PSD, AI', 'Reference videos of the assets; Editable PSD or AI source files'],
  ['VFX', 'PNG Sequence, spine', 'PNG with transparent background; 72 DPI resolution'],
  ['Audio', 'MP3, WAV, FLAC, ORG', 'Compressed music and sounds; Sounds as separate files'],
  ['Animations', 'Spline / PNG Sequence', 'Minimal number of frames in the sequence'],
  ['Brand book', 'Link, PDF', 'Logo usage guidelines, fonts, color palette, logo usage guidelines'],
  ['Build', 'APK, Unity Project', 'Test build with unlocked content'],
  ['Access', 'Open access to your application or game', 'Test account with full access to the app/game'],
  ['Images', 'PNG, JPEG, PSD, AI, CDR', 'Editable source files and transparent PNGs'],
  ['Guidlines', 'Link, PDF, TXT', 'Guid “do’s & don’ts”'],
  ['Videos', 'AEP, MP4, WAV', 'Screencasts, packshots, source files'],
  ['Sequentions', 'PNG, spine', 'Source animation files (if available); Original frame rate'],
  ['Scripts', 'DOC, DOCX, TXT', 'Any format'],
  ['Textures', 'PNG, JPEG, PSD, AI, CDR', 'Original texture files in the highest available resolution'],
]
